  ...
  return (
    <Modal visible={visible} transparent={true} animationType="fade" onRequestClose={handleExit}>
      <View className="flex-1" style={{ backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
        <GetLink visible={activeModal === 'main'} onHide={handleExit} handleSearch={handleSearch} />

        <SingleSong videoId={id} visible={activeModal === 'single'} onHide={handleExit} />

        <MultipleSongs playlistId={id} visible={activeModal === 'multiple'} onHide={handleExit} />
      </View>
    </Modal>
  );
}
